...
<script>
  import {queryByPage,createRole,updateRole,updateStatus,deleteRole} from '@/api/role';
    ...
    methods: {
      ...
      handleStatusChange(index, row) {
        this.$confirm('是否要修改该状态?', '提示', {
          ...
          type: 'warning'
            ...
            let params = Object.assign({},defaultRole);
            params.id = row.id;
      ...
      getList() {
        this.listLoading = true;
          queryByPage(this.listQuery).then(response => {
