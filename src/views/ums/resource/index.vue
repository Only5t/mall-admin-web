  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        this.resource.url = this.listQuery.urlKeyword;
        this.resource.name = this.listQuery.nameKeyword;
        this.resource.categoryId = this.listQuery.categoryId;
        fetchList(this.listQuery,this.resource).then(response => {
